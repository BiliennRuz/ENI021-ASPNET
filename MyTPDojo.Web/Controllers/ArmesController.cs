...
namespace MyTPDojo.Web.Controllers
{
    public class ArmesController : Controller
    {
        ...
        public ArmesController(MyTPDojoWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Arme != null ? 
                          ...
                          Problem("Entity set 'MyTPDojoWebContext.Arme'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyTPDojoWebContext.Arme'  is null.");
            }
            var arme = await _context.Arme.FindAsync(id);
            if (arme != null)
            {
