...
using BO;
using MyTPDojo.Web.Data;

namespace MyTPDojo.Web.Controllers
{
    public class SamouraisController : Controller
    {
        private readonly MyTPDojoWebContext _context;

        public SamouraisController(MyTPDojoWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Samourai != null ? 
                          ...
                          Problem("Entity set 'MyTPDojoWebContext.Samourai'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyTPDojoWebContext.Samourai'  is null.");
            }
            var samourai = await _context.Samourai.FindAsync(id);
            if (samourai != null)
            {
